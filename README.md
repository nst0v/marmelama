...
Проект заменяет старый PHP-сайт современной структурой: публичная часть работает на Blade-шаблонах, админка работает на Filament, данные из старого сайта импортируются отдельной artisan-командой.
